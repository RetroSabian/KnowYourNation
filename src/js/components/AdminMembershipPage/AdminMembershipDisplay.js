            ...
            <div className="AdminMembershipDisplay">
                ...
                <div className="container ">
                    <div className="row">
                        ...
                        <NavLink to="/AdminMembership">
                            <button className="reg-circle" onClick={this.createMembership}>+</button>
                        </NavLink>
                    </div>
                     <Display/>
                    <div className="col-12 marginTop20px">
                        <NavLink to='/AdminMembership'>
                            <button className="reg-circle" type="button" onClick={this.editMembership}> Edit</button>
                        </NavLink>
                    </div>
                </div>
            </div>
